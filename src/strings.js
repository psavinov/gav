...
const STRINGS = {
    ...
    "ru": {
        ...
        "too.much.effort": "Похоже, что Вы прикладываете слишком много усилий для достижения целей, работающих на менее значимые ценности. Возможно стоит уделять больше внимания тем целям, которые работаю на более важные для Вас ценности.",
